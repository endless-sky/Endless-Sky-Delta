...
sourceLib = env.StaticLibrary(pathjoin(libDirectory, "endless-sky-delta"), RecursiveGlob("*.cpp", buildDirectory))
...
sky = env.Program(pathjoin(binDirectory, "endless-sky-delta"), exeObjs + sourceLib)
env.Default(sky)
