...
const Command Command::LATERALLEFT(ONE << 32, "Lateral left thrust");
const Command Command::LATERALRIGHT(ONE << 33, "Lateral right thrust");
const Command Command::WAIT(ONE << 34, "");
const Command Command::STOP(ONE << 35, "");
const Command Command::SHIFT(ONE << 36, "");
const Command Command::CTRL(ONE << 37, "");
